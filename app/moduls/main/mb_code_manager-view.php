                ...
                <div class="alert alert-custom alert-light-primary " role="alert">
                    ...
                    <div class="alert-text">
                        <div class="w-100 d-flex flex-wrap gap-2">
                            <div class="infoItem"><?php echo  __("You can add custom codes to your website without making any changes to your theme and plugin files without the need for an FTP tool.","magicbox") ?></div>
                        </div>
                    </div>
                </div>
                <div class="row">
